            ...
            <nav id="sidebar" class="sidebar-nav navbar-collapse">
                ...
                <div class="sidebar-header text-center">
                    <a class="navbar-brand" href="{{ url('/home') }}">
                        <h3>
                            <svg width="70px" height="51px" style="margin-top: -60px;" viewBox="0 0 90 73" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>{{ config('app.name', 'Laravel') }}</title>
                                <desc></desc>
                                <defs></defs>
                    ...
                    <strong>
                        <a class="navbar-brand" href="{{ url('/home') }}">
                            <h3>
                                <svg width="70px" height="51px" style="margin-left: 0px;" viewBox="0 0 90 73" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>{{ config('app.name', 'Laravel') }}</title>
                                    <desc></desc>
                                    <defs></defs>
                                    <g id="web" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
